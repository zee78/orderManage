...
@section('css') 
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin-assets/assets/libs/select2/select2.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin-assets/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin-assets/assets/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css')}}">
        <link href="{{ URL::asset('admin-assets/assets/libs/bootstrap-timepicker/bootstrap-timepicker.min.css')}}" rel="stylesheet" type="text/css">
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin-assets/assets/libs/bootstrap-touchspin/bootstrap-touchspin.min.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('admin-assets/assets/libs/datepicker/datepicker.min.css')}}" type="text/css">
@endsection
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Easily select a time for a text input using your mouse or keyboards arrow keys.</p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="dd M, yyyy"  data-date-format="dd M, yyyy" data-provide="datepicker" data-date-autoclose="true">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                    </div>
                                                </div><!-- input-group -->
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="dd M, yyyy" data-provide="datepicker"  data-date-format="dd M, yyyy" data-date-multidate="true">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                    </div>
                                                </div><!-- input-group -->
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4 mt-sm-0">
                                                    ...
                                                    <div class="docs-options">
                                                        ...
                                                        <input type="number" class="form-control" name="zIndex" value="1000" aria-describedby="option-zIndex" placeholder="zIndex">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4 mt-xl-0">
                                                    ...
                                                    <div class="docs-toggles">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="form-check">
                                                            <input class="form-check-input" id="autoShow" type="checkbox" name="autoShow">
                                                            <label class="form-check-label" for="autoShow">autoShow</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="form-check">
                                                            <input class="form-check-input" id="autoHide" type="checkbox" name="autoHide">
                                                            <label class="form-check-label" for="autoHide">autoHide</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="form-check">
                                                            <input class="form-check-input" id="autoPick" type="checkbox" name="autoPick">
                                                            <label class="form-check-label" for="autoPick">autoPick</label>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="form-check">
                                                            <input class="form-check-input" id="yearFirst" type="checkbox" name="yearFirst">
...
@section('script')
        ...
        <script src="{{ URL::asset('admin-assets/assets/libs/select2/select2.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-timepicker/bootstrap-timepicker.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-touchspin/bootstrap-touchspin.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js')}}"></script>
        <script src="{{ URL::asset('admin-assets/assets/libs/datepicker/datepicker.min.js')}}"></script>

        <script src="{{ URL::asset('admin-assets/assets/js/pages/form-advanced.init.js')}}"></script> 
