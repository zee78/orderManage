      ...
      <div class="card-body">
        ...
        <form enctype="multipart/form-data" id="create-category-form">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-lg-10">
              <input id="categoryname" name="category_name" type="text" class="form-control" placeholder="Enter Category Name...">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label for="projectdesc" class="col-form-label col-lg-2">Category Description</label>
            <div class="col-lg-10">
              <textarea class="form-control" name="cat_desc" id="cat_desc" rows="3" placeholder="Enter Category Description..."></textarea>
            </div>
          </div>
        </form>
        <div class="row mb-4">
          ...
          <div class="col-lg-10">
            <!-- <div class="dropzone"> -->
              <div class="fallback form-control mb-3">
                <input name="cat_icon" onchange="catImg(this)" form="create-category-form" type="file" accept="image/png, image/gif, image/jpeg" />
              </div>
            ...
            <!-- </div> -->
            <img src="" id="icon_show">
          </div>
        </div>
        <div class="row justify-content-end">
          <div class="col-lg-10">
            <button type="submit" form="create-category-form" class="btn btn-primary">Add Category</button>
          </div>
        </div>
      </div>
    </div>
