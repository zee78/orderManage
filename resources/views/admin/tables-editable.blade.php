...
@section('script')
        ...
        <script src="{{ URL::asset('admin-assets/assets/libs/bootstrap-editable/bootstrap-editable.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('admin-assets/assets/js/pages/table-editable.init.js')}}"></script> 
